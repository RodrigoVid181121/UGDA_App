...
@nombre varchar(50), @apellido varchar(50), @carnet nchar(6), @correo varchar(150), @contrasenia varchar(20), @idcargo int
as
DECLARE @Idus int
...
UPDATE usuarios set nombre=@nombre, apellido=@apellido, carnet=@carnet, correo=@correo, contrasenia=@contrasenia, id_cargo=@idcargo
...
as
begin
SELECT u.carnet as Carnet, u.nombre as Nombre, u.apellido as Apellido, u.correo as Correo, u.contrasenia as Contrasenia, c.nombre_cargo as Cargo
 FROM usuarios u 
